...
public class UpsertSObjectSoapRequest implements Request{
	...
	public UpsertSObjectSoapRequest(ArrayList<SObject> records, HashMap<String, String> sessionFields) {
	...
	private String createSoapRequest(ArrayList<SObject> records, HashMap<String, String> sessionFields){
		...
		try {
			...
			serializer.startTag(URN, EXTERNAL_ID_FIELD_NAME);
			serializer.text(sessionFields.get("externalIdField"));
			serializer.endTag(URN, EXTERNAL_ID_FIELD_NAME);
